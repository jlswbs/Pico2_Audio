...
void loop1(){
  ...
  dsp->fHslider0 = random(100, 1000); // frequency Hz
  dsp->fHslider1 = randomf(0.1f, 0.99f); // feedback 0..1
  dsp->fHslider2 = randomf(0.1f, 3.99f); // shape 0..4
  dsp->fHslider3 = randomf(0.1f, 1.99f); // lfo 0..2
  dsp->fHslider4 = randomf(0.4f, 0.99f); // gain 0..1
